...
- Visit the [Releases page](https://github.com/DHEER31132005/task-planner/releases/tag/v_1.0.0) to download the latest version of the application.
...
1. **Clone the Repository**:
    ...
    ```bash
    git clone https://github.com/DHEER31132005/task-planner.git
    ```
